...
<div class="ht__bradcaump__area"
     style="background: rgba(0, 0, 0, 0) url(resources/client/images/bg/myinfo.jpg) no-repeat scroll center center / cover ;">
                    ...
                    <div class="ht__comment__form">
                        ...
                        <div class="ht__comment__form__inner">
                            <div class="comment__form">
                                ...
                                <input type="text" placeholder="우편 번호 * " name="cmAddressTbPostcode"
                                       id="cmAddressTbPostcode">
                                <input type="text" placeholder=" 주소 *" name="cmAddressTbAddress1"
                                       id="cmAddressTbAddress1">
                                <input type="text" placeholder="상세 주소 *" name="cmAddressTbAddress2"
                                       id="cmAddressTbAddress2">
                    ...
                    <form action="/myinfo-update-termsAgree.do" method="post">
                        <div class="ht__comment__form">
                            ...
                            <c:if test="${termsAgreeVO.termsAgreeTbConsentStatus eq 'Y'}">
                                <input type="radio" name="termsAgreeTbConsentStatus" value="Y"
                                       style="width:20px; height:20px; border:1px;" checked>동의&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="termsAgreeTbConsentStatus" value="N"
                                       style="width:20px; height:20px; border:1px;">비동의
                            </c:if>
                            <c:if test="${termsAgreeVO.termsAgreeTbConsentStatus eq 'N'}">
                                <input type="radio" name="termsAgreeTbConsentStatus" value="Y"
                                       style="width:20px; height:20px; border:1px;">동의&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="termsAgreeTbConsentStatus" value="N"
                                       style="width:20px; height:20px; border:1px;" checked>비동의
                            </c:if>
    ...
    $(document).ready(function () {
        ...
        $("#selectBox").change(function () {
            ...
            if (selectedValue === 'thisIsSelect') {
                ...
                $("#deleteBtn").hide();
                $("#cmAddressTbPostcode").val('');
                $("#cmAddressTbAddress1").val('');
                $("#cmAddressTbAddress2").val('');
                $("#cmAddressTbNickname").val('');
                $("#lat").val('');
                $("#lng").val('');

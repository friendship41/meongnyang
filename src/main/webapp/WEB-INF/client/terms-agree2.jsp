...
function popupClose(){
	...
	if(chkbox.checked){
		opener.document.getElementById("agreeCheckOption").value = 'Y';
	}else{
		opener.document.getElementById("agreeCheckOption").value = 'N';
	}
...
<body>
		...
		<table class="board_list">
			<tbody>
				<tr>
					<td colspan="3" class="signUp_agree">이용약관(선택)</td>
				</tr>				    
					<tr>					
				...
				<tr>
					<td colspan="3" class="signUp_agree_checkbox"><input type="checkbox" name="agree" id="agreeCheckbox">약관에 동의(선택)</td>
				</tr>
				<tr>

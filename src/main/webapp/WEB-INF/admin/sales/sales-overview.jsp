    ...
    <div class="page-content">
        ...
        <div class="page-inner">
                                ...
                                <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel-heading" role="tab" id="headingOne1">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion2" href="#1"
                                                   aria-expanded="true" aria-controls="collapseOne">기간별 매출 현황 </a>
                                            </h4>
                                        </div>
                                        <div id="1" class="panel-collapse collapse in" role="tabpanel"
                                             aria-labelledby="headingOne1">&nbsp;
                                            <input type='hidden' name='targets' value='dailySales'>
                                            <a href="javascript:void(0)" id="excelDown1"
                                               style="font-size: 25px; color: green;"><i class="fa fa-file-excel-o"
                                                                                         aria-hidden="true"></i><span
                                                    class="sr-only">&nbsp;&nbsp;</span>EXCEL</a>&nbsp;
                                            <a href="javascript:void(0)" id="pdfDown1"
                                               style="font-size: 25px; color: #B40431;"><i class="fa fa-file-pdf-o"
                                                                                           aria-hidden="true"></i> <span
                                                    class="sr-only">&nbsp;&nbsp;</span>PDF</a>
                                            <div class="panel-body">
                                                <div class="col-md-6">
                                                    <div class="panel-heading clearfix">
                                                    ...
                                                    <form class="form-horizontal" action="javascript:void(0);">
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="dailySalesStartDate"
                                                                               name="startDate"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="dailySalesEndDate"
                                                                               name="endDate"
                                                                               class="date-picker text-center form-control"
                                                    ...
                                                    <form class="form-horizontal" action="javascript:void(0);">
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="monthlySalesStartDate"
                                                                               name="startMonth"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/01/2020">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="monthlySalesEndDate"
                                                                               name="endMonth"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/15/2020"
                                                                               style="margin-bottom: 14px;">
                                    ...
                                    <div class="panel panel-success">
                                        <div class="panel-heading" role="tab" id="headingTwo2">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion2"
                                                   href="#2" aria-expanded="false" aria-controls="collapseTwo"> 카테고리별 매출
                                                    현황 </a>
                                            </h4>
                                        </div>
                                        <div id="2" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <a href="javascript:void(0)" id="excelDown2"
                                               style="font-size: 25px; color: green;"><i class="fa fa-file-excel-o"
                                                                                         aria-hidden="true"></i><span
                                                    class="sr-only">&nbsp;&nbsp;</span>EXCEL</a>&nbsp;
                                            <a href="javascript:void(0)" id="pdfDown2"
                                               style="font-size: 25px; color: #B40431;"><i class="fa fa-file-pdf-o"
                                                                                           aria-hidden="true"></i> <span
                                                    class="sr-only">&nbsp;&nbsp;</span>PDF</a>
                                            <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" action="javascript:void(0);">
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="categorySalesStartDate"
                                                                               name="startDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/01/2020">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="categorySalesEndDate"
                                                                               name="endDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/15/2020"
                                                                               style="margin-bottom: 14px;">
                                    ...
                                    <div class="panel panel-danger">
                                        <div class="panel-heading" role="tab" id="headingThree3">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion2"
                                                   href="#3" aria-expanded="false" aria-controls="collapseThree"> 가격별 매출
                                                    현황 </a>
                                            </h4>
                                        </div>
                                        <div id="3" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <a href="javascript:void(0)" id="excelDown3"
                                               style="font-size: 25px; color: green;"><i class="fa fa-file-excel-o"
                                                                                         aria-hidden="true"></i><span
                                                    class="sr-only">&nbsp;&nbsp;</span>EXCEL</a>&nbsp;
                                            <a href="javascript:void(0)" id="pdfDown3"
                                               style="font-size: 25px; color: #B40431;"><i class="fa fa-file-pdf-o"
                                                                                           aria-hidden="true"></i> <span
                                                    class="sr-only">&nbsp;&nbsp;</span>PDF</a>
                                            <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" action="javascript:void(0);">
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="dailySalesPriceStartDate"
                                                                               name="startDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/01/2020">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="dailySalesPriceEndDate"
                                                                               name="endDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/15/2020"
                                                                               style="margin-bottom: 14px;">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="monthlySalesPriceEndDate"
                                                                               name="endMonth"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/15/2020"
                                                                               style="margin-bottom: 14px;">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading" role="tab" id="headingFour4">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion2"
                                                   href="#4" aria-expanded="false" aria-controls="collapseTwo"> 지역별 매출
                                                    현황 </a>
                                            </h4>
                                        </div>
                                        <div id="4" class="panel-collapse collapse" role="tabpanel"
                                            ...
                                            <a href="javascript:void(0)" id="excelDown4"
                                               style="font-size: 25px; color: green;"><i class="fa fa-file-excel-o"
                                                                                         aria-hidden="true"></i><span
                                                    class="sr-only">&nbsp;&nbsp;</span>EXCEL</a>&nbsp;
                                            <a href="javascript:void(0)" id="pdfDown4"
                                               style="font-size: 25px; color: #B40431;"><i class="fa fa-file-pdf-o"
                                                                                           aria-hidden="true"></i> <span
                                                    class="sr-only">&nbsp;&nbsp;</span>PDF</a>
                                            <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" action="javascript:void(0);">
                                                        <div class="form-group">
                                                            <div class="col-sm-10">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="regionSalesStartDate"
                                                                               name="startDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/01/2020">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <input type="text" id="regionSalesEndDate"
                                                                               name="endDate"
                                                                               class="date-picker text-center form-control"
                                                                               placeholder="01/15/2020"
                                                                               style="margin-bottom: 14px;">
            ...
            <div class="page-footer">
                <p>
                    메인프로젝트 뭐멍냥 <i class="fa fa-heart"></i> by team4
                </p>
            </div>
        </div>
        <!-- /Page Inner -->
...
<script>
    ...
    $(function () {
		var sales_chart_day = null;
		var sales_chart_month = null;
		var category_sales_chart_day = null;
		var region_sales_chart_day = null;
		var price_sales_chart_day = null;
		var price_sales_chart_month = null;
        ...
        function dailySales() {
            ...
            $.ajax({
                ...
                .done(function (map) {
                    if (sales_chart_day != null) {
                        sales_chart_day.destroy();
                    }
                    sales_chart_day = new Chart(document.getElementById("sales_chart_day"), map.chart);
        ...
        function monthlySales(event) {
            ...
            $.ajax({
                ...
                .done(function (json) {
                    if (sales_chart_month != null) {
                        sales_chart_month.destroy();
                    }
                    sales_chart_month = new Chart(document.getElementById("sales_chart_month"), json.chart);
                    if (event != null) {
        ...
        function categorySales() {
            ...
            $.ajax({
                ...
                .done(function (data) {
                    if (category_sales_chart_day != null) {
                        category_sales_chart_day.destroy();
                    }
                    category_sales_chart_day = new Chart(document.getElementById("category_sales_chart_day"), data.chart);
        ...
        function regionSales() {
            ...
            $.ajax({
                ...
                .done(function (data) {
                    if (region_sales_chart_day != null) {
                        region_sales_chart_day.destroy();
                    }
                    region_sales_chart_day = new Chart(document.getElementById("region_sales_chart_day"), data.chart);
        ...
        function dailySalesPrice() {
            ...
            $.ajax({
                ...
                .done(function (map) {
                    if (price_sales_chart_day != null) {
                        price_sales_chart_day.destroy();
                    }
                    price_sales_chart_day = new Chart(document.getElementById("price_sales_chart_day"), map.chart);
        ...
        function monthlySalesPrice(event) {
            ...
            $.ajax({
                ...
                .done(function (json) {
                    price_sales_chart_month = new Chart(document.getElementById("price_sales_chart_month"), json.chart);
                    if (event != null) {
        ...
        $("#monthlySalesPrice").on('click', function () {
			if (price_sales_chart_month != null) {
				price_sales_chart_month.destroy();
			}
